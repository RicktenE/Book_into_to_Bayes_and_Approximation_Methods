...
The Python code uses NumPy to generate observations and likelihood calculations. It initializes particles and weights using numpy.random.normal, updates weights based on the likelihood, performs resampling using numpy.random.choice, and estimates the filtered state using the mean of the particles. The results are plotted using matplotlib.pyplot.plot.

You can run either the R or Python code to see the particle filter in action for the toy example. Feel free to adjust the parameters, such as the number of time steps and particles, to explore different scenarios.
...
<!-- # Function to generate observations -->
<!-- def generate_observations(time_steps, true_states): -->
<!--     observations = np.random.normal(true_states, 1, time_steps) -->
<!--     return observations -->

<!-- # Function to calculate the likelihood of a particle -->
<!-- def calculate_likelihood(particle, observation): -->
<!--     likelihood = np.random.normal(observation, 1, particle) -->
<!--     return likelihood -->

<!-- # Particle Filter SMC function -->
<!-- def particle_filter_smc(time_steps, num_particles): -->
<!--     # Initialize particles and weights -->
<!--     particles = np.random.normal(0, 1, num_particles) -->
<!--     weights = np.ones(num_particles) / num_particles -->

<!--     # Initialize estimates -->
<!--     filtered_states = np.zeros(time_steps) -->

<!--     for t in range(time_steps): -->
<!--         # Generate observations -->
<!--         true_state = np.sin(t/5)  # True state at time t -->
<!--         observation = generate_observations(1, true_state) -->
...
<!-- # Plot the results -->
<!-- plt.plot(filtered_states) -->
<!-- plt.title("Particle Filter SMC in Python") -->
<!-- plt.show() -->
